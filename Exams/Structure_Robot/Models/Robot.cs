...
namespace Structure_Robot.Models
{
    public abstract class Robot : IRobot
    {
        ...
        public bool ExecuteService(int consumedEnergy)
        {
            ...
            {
                //decrease the BatteryLevel with the given amount of consumedEnergy and return True.
                BatteryLevel -= consumedEnergy;
                return true;
            }
            else
            {
                //•	If the BatteryLevel is less than the given consumedEnergy,
                //it means that it is NOT enough. Skip the execution and return False.
                return false;
            }
        }
        public override string ToString()
        {
            ...
            //            --Supplements installed: { standard1}
            //            { standard2}…/ none"
            ...
            {
                foreach (var standart in interfaceStandards)
                {
                    sb.Append($"{standart} "); 
                }
            }
